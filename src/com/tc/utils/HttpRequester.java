...
import com.tc.bean.HttpResponse;
...
public class HttpRequester {
	 ...
	 * @throws java.io.IOException
	 */
	public HttpResponse sendDelete(String urlString,
			Map<String, Object> params, Map<String, String> propertys)
			throws IOException {
	...
	private HttpResponse send(String urlString, String method,
		...
		if ((method.equalsIgnoreCase(METHOD_GET)
				|| method.equalsIgnoreCase(METHOD_DELETE) || method
					.equalsIgnoreCase(METHOD_PUT)) && parameters != null) {
